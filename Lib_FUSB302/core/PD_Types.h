...
typedef enum
{
    ...
    dbgGetRxPacket,             /* Debug point for peeking at Rx packet handling */
    dbgSendTxPacket,            /* Debug point for peeking at Tx packet handling */
...
typedef enum
{
    CBL_RST_DISABLED,
    CBL_RST_START,
    CBL_RST_WAIT_VCONN_SWAP,
    CBL_RST_WAIT_DR_SWAP,
} CableResetState_t;
