                                ...
                                FSC_U32 length_in)
{
    ...
    if (vdmh_in.SVDM.CommandType == INITIATOR)
    {
        ...
        if (id.nack == FALSE)
        {
            ...
            if ((idh.product_type == PASSIVE_CABLE)
                    || (idh.product_type == ACTIVE_CABLE))
            {
                CableVdo cvdo_out;
...

    {
        ...
        if (vdmh_in.SVDM.CommandType == RESPONDER_ACK)
        {
            ...
            if ((id.id_header.product_type == HUB) ||
            ...
            if ((id.id_header.product_type == PASSIVE_CABLE) ||
                (id.id_header.product_type == ACTIVE_CABLE))
            {
            ...
            if ((id.id_header.product_type == AMA))
            {
                id.has_ama_vdo = TRUE;
